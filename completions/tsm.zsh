    ...
    case "$line[1]" in
        ...
        dir)
            _alternative \
                ...
                'options:option:(--start-default --use-default-name)'
            ;;
        git)
            _values -s ' ' 'git options' '--hide-brief' '--no-fetch' '--start-default' '--use-default-name'
            ;;
        worktree)
            _alternative \
            ...
            ;;
        zoxide)
            _values 'zoxide options' '--start-default' '--use-default-name'
            ;;
        configured)
            _tsm_configured_sessions
            ;;
