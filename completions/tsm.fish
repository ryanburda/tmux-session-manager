...
complete -c tsm -n '__fish_use_subcommand' -a apply-default-config -d 'Apply the shared default configuration'
...
complete -c tsm -n '__fish_seen_subcommand_from dir' -xa '-c --no-custom-config -d --no-default-config -p --prompt-name'
...
complete -c tsm -n '__fish_seen_subcommand_from zoxide' -xa '-c --no-custom-config -d --no-default-config -p --prompt-name'
