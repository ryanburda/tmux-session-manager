...
complete -c tsm -n '__fish_seen_subcommand_from dir' -xa '--start-default'
complete -c tsm -n '__fish_seen_subcommand_from git' -xa '--hide-brief --no-fetch --start-default'
complete -c tsm -n '__fish_seen_subcommand_from worktree' -xa '(__tsm_worktrees)'
complete -c tsm -n '__fish_seen_subcommand_from worktree' -xa '--start-default'
complete -c tsm -n '__fish_seen_subcommand_from zoxide' -xa '--start-default'
