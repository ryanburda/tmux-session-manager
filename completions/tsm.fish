...
complete -c tsm -n '__fish_seen_subcommand_from dir' -xa '-c --not-configured -d --no-start-default -p --prompt-name'
complete -c tsm -n '__fish_seen_subcommand_from git' -xa '-b --brief -f --fetch -c --not-configured -d --no-start-default -p --prompt-name'
complete -c tsm -n '__fish_seen_subcommand_from worktree' -xa '(__tsm_worktrees)'
complete -c tsm -n '__fish_seen_subcommand_from worktree' -xa '-c --not-configured -d --no-start-default -p --prompt-name'
complete -c tsm -n '__fish_seen_subcommand_from zoxide' -xa '-c --not-configured -d --no-start-default -p --prompt-name'
