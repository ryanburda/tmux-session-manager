...
complete -c tsm -n '__fish_seen_subcommand_from dir' -xa '-n --no-default-setup -p --prompt-name'
complete -c tsm -n '__fish_seen_subcommand_from git' -xa '-b --brief -f --fetch -n --no-default-setup -p --prompt-name'
complete -c tsm -n '__fish_seen_subcommand_from worktree' -xa '(__tsm_worktrees)'
complete -c tsm -n '__fish_seen_subcommand_from worktree' -xa '-n --no-default-setup -p --prompt-name'
complete -c tsm -n '__fish_seen_subcommand_from zoxide' -xa '-n --no-default-setup -p --prompt-name'
